/*
** Module: openiod-fiware-controller-ttn.js
...
Id: openiod-fiware-controller-ttn
...
This module validates and transforms attribute from the external system ttn https://data.ttn.nl provided by (Scapeler) SCAPE604/ttn-data/ttn-import.sh
...
module.exports = {
	...
	setDefaults(){
		...
		_defaults.source = "https://data.ttn.nl";
	},
	getDefaults(){
		return _defaults;
	},
